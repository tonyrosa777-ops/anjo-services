 ...
 *
 * Architecture:
 *   - Page Header Standard (Fragment root, dark bg + radial overlay + 2
 *     ambient orbs, content z-10, h1 = .hero-shimmer font-display text-h1
 *     font-bold). Sitewide aesthetic per feedback_dark-page-headers-not-red.md.
